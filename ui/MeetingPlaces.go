...
type MeetingPlaces struct {
	collection map[string]MeetingPlace
	PublicAPI
}

func NewMeetingPlaces () MeetingPlaces {
	obj := MeetingPlaces{}
	obj.collection = make(map[string]MeetingPlace,0)
	return obj
}
...
func(this MeetingPlaces) View(id string)MeetingPlace{
...
func(this MeetingPlaces) Delete(id string) {
